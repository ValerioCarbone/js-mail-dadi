...
const numberMailsArray = mailsArray.length - 1;
...
const numberUser = parseInt(getRandomArbitrary(1, 6));
// - Generare numero randomico per il computer
const numberComputer = parseInt(getRandomArbitrary(1, 6));

// - Confrontare i numeri
const numbersRandomArray = [numberUser, numberComputer];
